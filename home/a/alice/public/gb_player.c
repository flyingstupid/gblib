...
int DoSkillRoll(string skill, int diff)
{
	...
	writeValue = skillValue-d100;
	
	write("Rolling: [" + skill + "] of "+ this_user()->get_skill(skill) +" @ Difficulty of [" + diff +"]  Roll was: ["+ d100 + "]\n" + "Result:" + writeValue + ".\n");
    return skillValue-d100;
}
...
void DoSkillXp(string skill)
{
        ...
        if(firstD100 > skillValue && secondD100 > skillValue)
        {
                ...
                write("You believe you've learned something about " + skill +
".\n");
        }
