...
int execute_movement(string verb, string arg)
{
    ...
    */
    ...
    {
        tell_room( env, query_cap_name() + " trys to go " + verb + " but the
closed door has other ideas." + "\n", this_object() );
        tell_object( this_object(), "You bump into a closed door trying to go "
+ verb + ".\n" );
        return 1;
    }
...
this_object() );
    ...
    {
        tell_room( env->query_exit( verb ), query_cap_name() + " has entered the
room.\n", this_object() );
    }
    ...
    {
        tell_room( env, query_cap_name() + " leaves through the " + verb + "
exit.\n", this_object() );
    }

    // Tell the player that the move happend
    tell_object( this_object(), "You move to " +
environment(this_object())->query_exit(verb)->query_short() + ".\n\n" );
...
int DoSkillRoll(string skill, int diff)
{
    ...
    tell_object(this_object(), "Rolling: [" + skill + "] of "+ get_skill(skill) +" @ Difficulty of [" + diff +"]  Roll was: ["+ d100 + "]\n" + "Result:" + returnValue + ".\n");
...
{   
    ...
    {
        set_skill(skill, skillValue+1); 
        tell_object(this_object(), "You believe you've learned something about " + skill + ".\n");
    }
}
