...
int DoResearchDisplay()
{
    ...
    researchString += "You are currently preparing " + sizeof(this_player()->GetNumProjects()) + " samples\n";
    researchString +=
    "============================================================================\n";
	...
	else
	{
		...
		if(skillTest<1)
		{
			...
			if(skillTest<20)
			{
                ...
                write("You prepare " + item->query_short() +" to be better understand it
                      when someone examines it.\n");
			}
			else if(skillTest>40)
			{
                item->SetResearchQuality(item->SetResearchQuality() + 1.2);
                write("You prepare " + item->query_short() +" to better understand it when
                      someone examines it.\n");
			}
          ...
          //this_player()->SetNumProjects(-1);
            ...
            RESEARCH_D->AddProject("slime", item, this_player());
            destruct(item);
