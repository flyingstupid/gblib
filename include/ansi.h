 ...
 *
 * Last edited on 8th April, 2007 by Tricky @ LPUniversity (added ORANGE)
 *
 */
...
#define HIK "%^BOLD%^%^BLACK%^"    /* HI-Black    */
#define HIR "%^BOLD%^%^RED%^"      /* HI-Red      */
#define HIG "%^BOLD%^%^GREEN%^"    /* HI-Green    */
#define HIO "%^BOLD%^%^ORANGE%^"   /* HI-Orange   */
...
#define HBORA "%^BOLD%^%^B_ORANGE%^"    /* HIB-Orange  */
